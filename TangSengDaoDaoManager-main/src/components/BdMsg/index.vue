<template>
  <div>
    ...
    <!-- 动态表情 -->
    <el-button v-else-if="msg.type == 12" type="primary" link @click="openMedia(`${url}${msg['url']}`)"> 查看动态表情 </el-button>
    <!-- 矢量emoji -->
    <template v-else-if="msg.type == 13">
      <el-button v-if="msg.type == 13 && msg['url']" type="primary" link @click="openMedia(`${url}${msg['url']}`)">
        查看矢量 emoji
      </el-button>
