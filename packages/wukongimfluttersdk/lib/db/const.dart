...
class WKDBConst {
  ...
  static const tableMessageFts = 'message_fts';
  ...
  static WKMsg serializeWKMsg(dynamic data) {
    ...
    msg.serverMsgID = readString(data, 'server_msg_id');
    ...
    msg.flame = readInt(data, 'flame');
    msg.flameSecond = readInt(data, 'flame_second');
    ...
    final localExtra = readDynamic(data, 'extra');
    if (localExtra is Map) {
      msg.localExtraMap = <String, dynamic>{
        ...Map<String, dynamic>.from(localExtra),
        'flame': msg.flame,
        'flame_second': msg.flameSecond,
      };
    } else {
      msg.localExtraMap = <String, dynamic>{
        'flame': msg.flame,
