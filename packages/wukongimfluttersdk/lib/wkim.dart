...
class WKIM {
  ...
  Future<bool> setup(Options opts) async {
    messageManager.stopExpireMessageCheckTimer();
    options = opts;
    ...
    if (isApp()) {
      ...
      if (result) {
        ...
        messageManager.startExpireMessageCheckTimer();
      }
      return result;
    }
    return true;
  ...
  _initNormalMsgContent() {
    ...
    messageManager.registerMsgContent(WkMessageContentType.gif, (dynamic data) {
      return WKGifContent().decodeJson(data);
    });
    messageManager.registerMsgContent(WkMessageContentType.sticker,
        (dynamic data) {
    ...
    messageManager.registerMsgContent(20, (dynamic data) {
      return WKScreenshotContent().decodeJson(data);
    });
    messageManager.registerMsgContent(14, (dynamic data) {
      return WKRichTextContent().decodeJson(data);
    });
  }
