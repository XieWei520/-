...
class WKSyncMsg {
  ...
  WKMsg getWKMsg() {
    ...
    msg.serverMsgID = serverMsgID.isNotEmpty ? serverMsgID : messageID;
    ...
    msg.wkMsgExtra!.isPinned =
        messageExtra != null && messageExtra!.isPinned != 0
            ? messageExtra!.isPinned
            : isPinned;
