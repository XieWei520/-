...
void main() {
  group('ChannelApi', () {
    ...
    test('getChannelInfo parses direct channel response and msg_auto_delete extra', () async {
      ...
      expect(adapter.lastRequestOptions?.path, '/v1/channels/u_auto_delete/1');
    ...
    test('setMessageAutoDelete uses POST /v1/channels/:channel_id/:channel_type/message/autodelete', () async {
      final adapter = _RecordingJsonAdapter(
