...
void main() {
  test('message mapper prefers edited content when remote extra refresh arrives', () {
    final message = WKMsg()
  ...
  testWidgets('edit action enters composer edit state and submits message edit', (
    tester,
  ) async {
