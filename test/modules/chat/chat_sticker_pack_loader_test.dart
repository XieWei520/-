...
void main() {
  ...
  test('bundled sticker pack uses lightweight previews before full animations', () async {
    ...
    for (final sticker in samplePack.stickers) {
      ...
      expect(
        ...
        reason: '${sticker.stickerId} preview should stay cheap to fetch/decode',
      );
    }
  });

  test('pubspec includes nested sticker preview assets in web release builds', () {
    ...
    expect(stickerAssetLines, contains('- assets/stickers/sample_pack/previews/'));
