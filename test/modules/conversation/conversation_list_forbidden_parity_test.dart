...
void main() {
  group('Android conversation forbidden parity', () {
    test(
      'shows forbidden icon only for normal group members when channel is forbidden',
      () {
        ...
        expect(
          resolveConversationForbiddenState(
            channel: channel,
            currentMember: normalMember,
          ),
          isTrue,
        );
        expect(
