...
Push-Location (Join-Path $root "tools\mengxia_monitor_shell_app")
try {
    Invoke-Checked flutter pub get
...
Invoke-Checked flutter build windows --release `
    --dart-define=WK_PROD_BASE_URL=https://infoequity.cn `
    --dart-define=WK_PROD_WS_ADDR=wss://infoequity.cn/ws
