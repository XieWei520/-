...
class WKMultiForwardBubble extends StatelessWidget {
  ...
  const WKMultiForwardBubble({super.key, required this.message, this.isMe = false});
      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(message.content, style: TextStyle(color: isMe ? Colors.white : Colors.black), maxLines: 3, overflow: TextOverflow.ellipsis),
          ],
        ),
      ),
    );
