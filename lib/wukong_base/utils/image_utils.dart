...
class WKImageUtils {
  ...
  static Size calculateThumbnailSize(Size original, {double maxWidth = 200, double maxHeight = 200}) {
  ...
  static BorderRadius getImageBorderRadius(Size size, {double defaultRadius = 8}) {
