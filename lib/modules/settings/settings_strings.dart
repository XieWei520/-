...
const SettingsStrings _zhHansSettingsStrings = SettingsStrings(
  ...
  locked: '已锁定',
  unlocked: '未锁定',
  exitAllPcWebLogin: '退出全部 PC/Web 登录',
...
const SettingsStrings _enUsSettingsStrings = SettingsStrings(
  generalMenu: 'General',
  notificationsMenu: 'New Message Notifications',
  favoritesMenu: 'Favorites',
  privacyMenu: 'Privacy',
  accountSecurityMenu: 'Account & Security',
  pcLoginMenu: 'PC Login',
  ...
  messageBackup: 'Message Backup',
  messageRecovery: 'Message Recovery',
  appModules: 'Enterprise Modules',
  thirdPartySharing: 'Third-Party Sharing List',
  errorLogs: 'Debug Logs',
  about: 'About',
  logout: 'Log Out',
  save: 'Save',
  cancel: 'Cancel',
  ...
  englishDisplay: 'English',
  clearImageCacheMessage: 'Clear image cache on this device?',
  clearImageCacheSuccess: 'Image cache cleared.',
  logoutMessage: 'Log out of the current account?',
  logoutAction: 'Log Out',
  logoutFailedPrefix: 'Log out failed: ',
  clearAllChatHistoryMessage: 'Clear all chat history for the current account?',
  clearAllChatHistorySuccess: 'Chat history cleared.',
  notificationSettingsTitle: 'New Message Notifications',
  notificationMasterSwitchTitle: 'New Message Notifications',
  notificationMasterSwitchDescription:
      'Turn this off to stop in-app alerts while message sync continues normally.',
  showMessageDetailsTitle: 'Show Message Details',
  sound: 'Sound',
  vibration: 'Vibration',
  notificationSoundDescription:
      'Sound and vibration can still be affected by system notification permissions and device restrictions.',
  openMessageNotificationSettings: 'Open New Message Notification Settings',
  openCallInvitationNotificationSettings:
      'Open Call Invitation Notification Settings',
  openSettingsFailedSuffix: ' failed. Please open it in system settings.',
  notificationPermissionHint:
      'If notifications are enabled in the app but alerts still do not arrive, check the system notification permission for this app.',
  callPermissionHint:
      'If call invites are not alerting, check system notification permission and background-running restrictions.',
  notificationSaveSuccess: 'Notification settings saved.',
  notificationSaveFailedPrefix: 'Save failed: ',
  privacySettingsTitle: 'Privacy Settings',
  privacyHeroTitle: 'Privacy & Security',
  privacyHeroSubtitle:
      'Manage discoverability, device protection, online status, and notification previews.',
  visibilitySectionTitle: 'Visibility',
  disablePhoneSearchTitle: 'Disable Phone Number Search',
  disablePhoneSearchSubtitle:
      'When enabled, people cannot find your account by phone number.',
  showOnlineStatusTitle: 'Show Online Status',
  showOnlineStatusSubtitle:
      'When disabled, friends cannot see your online presence.',
  showMessagePreviewTitle: 'Show Message Details in Notifications',
  showMessagePreviewSubtitle:
      'When disabled, push notifications hide the detailed message content.',
  securitySectionTitle: 'Security',
  deviceLockTitle: 'Device Lock',
  deviceLockSubtitle: 'Require extra verification when opening the app.',
  blacklistTitle: 'Blacklist',
  blacklistSubtitle: 'Manage blocked contacts.',
  settingsSaved: 'Settings saved.',
  saveFailedPrefix: 'Save failed: ',
  setDeviceLock: 'Set Device Lock',
  enterPassword: 'Enter Password',
  passwordHint6Digits: '6-digit numeric password',
  confirmPassword: 'Confirm Password',
  deviceLockPasswordMustBe6Digits: 'Device lock password must be 6 digits.',
  passwordsDoNotMatch: 'Passwords do not match.',
  enableDeviceLockFailedPrefix: 'Failed to enable device lock: ',
  disableDeviceLockFailedPrefix: 'Failed to disable device lock: ',
  accountSecurityTitle: 'Account & Security',
  accountAndDevicesTitle: 'Account and Devices',
  accountAndDevicesSubtitlePrefix: 'You currently have ',
  accountAndDevicesSubtitleSuffix: ' signed-in devices.',
  signedInDevicesSection: 'Signed-in Devices',
  accountActionsSection: 'Account Actions',
  deviceListTitle: 'Device List',
  devicesCountSuffix: ' devices',
  destroyAccountTitle: 'Delete Account',
  destroyAccountSubtitle:
      'Send a verification code, then permanently delete the current account.',
  destroyAccountDialogTitle: 'Delete account?',
  destroyAccountDialogMessage:
      'This will sign you out and permanently delete the current account.',
  destroyAccountVerificationHint: 'Enter SMS code',
  destroyAccountSendCode: 'Send code',
  destroyAccountSending: 'Sending...',
  destroyAccountConfirmAction: 'Delete account',
  destroyAccountSuccess: 'Account deleted',
  destroyAccountCodeRequired: 'Please enter the SMS code',
  destroyAccountSendCodeFailedPrefix: 'Failed to send delete-account code: ',
  destroyAccountFailedPrefix: 'Failed to delete account: ',
  signedInDevicesTitle: 'Signed-in Devices',
  loading: 'Loading...',
  noDevices: 'No devices',
  removeDeviceTitle: 'Remove Device',
  removeDeviceMessage: 'Are you sure you want to remove this device?',
  remove: 'Remove',
  removeFailedPrefix: 'Remove failed: ',
  unknownDevice: 'Unknown device',
  currentDevice: 'Current device',
  blacklistPageTitle: 'Blacklist',
  blacklistEmpty: 'Blacklist is empty.',
  blacklistEmptyHint: 'No blocked contacts right now.',
  ...
  pcLoginPageTitle: 'PC Login',
  loadingWebLoginAddress: 'Loading web login address...',
  pcLoginGuideDescription:
      'Use the address below to sign in on Web/PC, or scan the QR code from the login page.',
  copyAddress: 'Copy Address',
  copyWebLoginUrl: 'Copy the Web login URL',
  webLoginAddressCopied: 'Web login address copied',
  scanQrCode: 'Scan QR Code',
  useMobileScanToConfirmLogin: 'Use mobile scan to confirm login',
  pcLoginStatus: 'PC Login Status',
  openManagementControls: 'Open management controls',
  phoneMute: 'Phone Mute',
  muted: 'Muted',
  ...
  locked: 'Locked',
  unlocked: 'Unlocked',
  exitAllPcWebLogin: 'Exit All PC/Web Logins',
  pcLoginLockedNotice: 'PC login locked.',
  phoneNotificationsMuted: 'Phone notifications are muted.',
  phoneNotificationsEnabled: 'Phone notifications are enabled.',
  pcLoginHeroTitle: 'WuKongIM PC Login',
  ...
  workplaceCatalogEntryTitle: 'Workplace Apps',
  workplaceCatalogEntrySubtitle:
      'Browse banners, recent activity, and category apps.',
  workplaceCatalogBrowseAction: 'Browse',
  workplaceCatalogPageTitle: 'Workplace Apps',
  workplaceCatalogHeroTitle: 'Workplace Apps',
  workplaceCatalogHeroSubtitle:
      'Jump into the workplace from added apps, recent activity, and the category catalog.',
  workplaceCatalogBannersSectionTitle: 'Featured',
  workplaceCatalogMyAppsSectionTitle: 'Added Apps',
  workplaceCatalogRecentSectionTitle: 'Recently Used',
  workplaceCatalogCategoriesSectionTitle: 'Categories',
  workplaceCatalogCategoryAppsSectionTitle: 'Category Apps',
  workplaceCatalogEmptyHint: 'No workplace apps are available right now.',
  workplaceCatalogAddAction: 'Add',
  workplaceCatalogRemoveAction: 'Remove',
  workplaceCatalogOpenAction: 'Open',
  workplaceCatalogOpenFailedPrefix: 'Failed to open workplace app: ',
  workplaceCatalogPendingNativeRoutePrefix: 'Native route is not wired yet: ',
  workplaceCatalogNoLaunchRoute:
      'This app does not expose a launchable link yet.',
);
