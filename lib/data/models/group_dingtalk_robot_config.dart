class GroupDingTalkRobotConfig {
  ...
  const GroupDingTalkRobotConfig({
  ...
  factory GroupDingTalkRobotConfig.fromJson(Map<String, dynamic> json) {
    return GroupDingTalkRobotConfig(
  ...
  GroupDingTalkRobotConfig copyWith({
    String? groupNo,
    String? webhookUrl,
    String? secret,
    bool? enabled,
